...
# More passwords to test
test_passwords = ["sy@gmail.com", "Sy@gmail.com", "sygmail", "sy1234", "1234", "12345", "qwerty", "abc123", "password123", "sy@123"]

def hash_password(password):
    return hashlib.sha256(password.encode()).hexdigest()

print("Testing more passwords for sy@gmail.com:")
